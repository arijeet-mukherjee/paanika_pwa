...
function PaymentStatus(props) {
	...
	useEffect(() => {
		location && location.state && location.state.data
			? setPaymentStatusData(location.state.data)
	...
	return isSuccess ? (
		<>
			<div className="success-wrapper">
				<div className="success">
					<p className="icon">Order Placed Succesfully 🥳🥳🥳</p>
					...
					<span>
						{paymentStatusData &&
							...
							generateHTMLTable(
								JSON.parse(JSON.stringify(paymentStatusData.data))
							)}
					</span>
					<Link to="/">
						<button
		...
		<>
			<div className="success-wrapper">
				<div className="error">
					<p className="icon">Transaction Failed 🥲🥲🥲</p>
					...
					<span className="description">
						{paymentStatusData && paymentStatusData.data
							? paymentStatusData.data.order_status +
							  paymentStatusData.data.status_message
							: ""}{" "}
						<br />
					</span>
