...
function ProductDetail(props) {
	...
	function getProductDetails() {
		Util.apiCall(
			"GET",
			Util.baseUrl,
			`products/${productId}?getCategory=1&getDetail=1&stock=1`,
			Util.header
		)
			.then((dt) => {
				...
				productImageShow(
					Util.imageUrl + dt.data.product_gallary_detail[0].gallary_name
				);
				setIsLoading(false);
			})
			.catch((e) => {
				...
				<ol className="breadcrumb p-3">
					...
					<li className="breadcrumb-item">
						<a className="text-decoration-none link-secondary" href="!#">
							{productDetail
								? productDetail.category[0].category_detail.detail[0].name
								: "Sarees"}
						</a>
					</li>
				...
				<div className="col-lg-5">
					<div className="d-flex flex-column h-100">
						...
						<h4 className="text-muted mb-4">
							₹{productDetail ? productDetail.product_price : "10000"}
						</h4>
						...
						<dl className="row">
							...
							<dd className="col-sm-8 mb-3">
								<Ratings
									rating={
										productDetail && productDetail.product_rating
											? parseFloat(productDetail.product_rating)
											: 0.0
									}
						...
						<div className="lead flex-shrink-0 mb-3">
							{productDetail
								? ReactHtmlParser(
										productDetail.detail[0].desc.replace(
											/\|&;\$%@"<>\(\)\+,/g,
											""
										)
								  )
						...
						<div className="lead flex-shrink-0">
							{productDetail
								? ReactHtmlParser(
										productDetail.category[0].category_detail.detail[0].description.replace(
											/\|&;\$%@"<>\(\)\+,/g,
											""
										)
								  )
