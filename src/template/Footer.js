		...
		<footer className="mt-auto py-2 footer">
			...
			<div className="d-flex flex-column py-4">
				<div className="d-flex justify-content-center flexContainerFooter">
					...
					<a
						href="https://mail.google.com/mail/?view=cm&fs=1&to=paanikabyamita@gmail.com"
						className="me-5"
					>
			...
			<div className="d-flex flex-column py-4">
				<div className="d-flex justify-content-center">
					<a href="https://www.instagram.com/paanikabyamrita/" className="me-5">
			...
			<div className="container d-flex justify-content-center">
				<span className="text-muted">
					{" "}
					email us: Paanikabyamrita@gmail.com, Whatsapp: +91 99862 02185,
					Address: Bangalore | Copyright &copy; Paanika 2023
				</span>
			</div>
		</footer>
	);
